...
public class inserting_spot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //todo  Spot spot=new Spot(Integer.valueOf(user_id),address,spot_local_ref,description,category,size);

        Button m_confirm_button=(Button) findViewById(R.id.confirm);
        Button m_cancel_button=(Button) findViewById(R.id.cancel);

       //todo m_confirm_button.setOnClickListener(view->doPost_confirm_on_inserting_spot(spot));
